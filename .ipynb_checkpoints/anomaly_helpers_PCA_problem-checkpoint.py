...
def draw_decision_function(X_test, y_test, clf, n_bins=100):
    ...
    plt.hist(scoring[y_test.attack == 1], bins, alpha=0.5, label='True attacks')
...
def build_and_evaluate_anomaly_detector_v1(dataset, 
                                        # training_samples=10000,   # not used in this implementation
                                        training_data_contamination=0.1, 
                                        expected_contamination=0.2,
                                        with_PCA = False):
...
############################
def detailed_evaluation(dataset,clf):
    # Load training set
    X_train = dataset["data_train"]
    y_train = dataset["labels_train"]
...
# single function that works

def build_and_evaluate_anomaly_detector2(dataset, 
                                        # training_samples=10000,   # not used in this implementation
                                        expected_contamination=0.2,
                                        with_PCA = False):
